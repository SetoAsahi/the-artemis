...
function render(){
  ...
  q('#brandSubtitle').textContent=b.subtitle||'LUXURY CABARET';q('#heroSubtitle').textContent=b.subtitle||'';q('#heroTagline').textContent=b.tagline||'';q('#heroIntro').textContent=b.intro||'';q('#heroImage').src=b.heroImage||'/assets/hero-lounge.jpg';document.title=`${b.name||'The Artemis'} | Luxury Cabaret`;
